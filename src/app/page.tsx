  ...
  return (
    <main>
      ...
      <div className="flex flex-col gap-1">
        <a href="/lunacal-inline" target="_blank" rel="noopener noreferrer"> lunacal-inline</a>
        <a href="/lunacal-floating" target="_blank" rel="noopener noreferrer"> lunacal-floating</a>
        <a href="/lunacal-popup" target="_blank" rel="noopener noreferrer"> lunacal-popup</a>
