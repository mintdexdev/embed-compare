...
import { ZCAL_INLINE_SCRIPT_SRC, ZCAL_INLINE_LINK } from "@/lib/zcal-inline-init";
  ...
  return (
    <main>
      ...
      <div className="zcal-inline-widget">
        <a href={ZCAL_INLINE_LINK}>Testing event - Schedule a meeting</a>
      </div>

      <Script src={ZCAL_INLINE_SCRIPT_SRC} />
    </main>
  );
}
