...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-red-900">
      <link rel="dns-prefetch" href="https://app.lunacal.ai" />
      <link rel="preconnect" href="https://app.lunacal.ai" crossOrigin="" />
      ...
      <div className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black dark:text-zinc-50">
            Lunacal embed with resource hints.
          </h1>
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            <code className="font-mono">dns-prefetch</code> and{" "}
            <code className="font-mono">preconnect</code> warm up the connection
            to <span className="font-mono">app.lunacal.ai</span> before the
            script needs it.
          </p>
        </div>
      </div>
