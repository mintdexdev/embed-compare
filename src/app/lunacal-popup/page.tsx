...
import { lunacalPopupInitScript } from "@/lib/lunacal-popup-init";
...
export default function Page() {
  return (
    <main>
          ...
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
              <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Get started
                <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://w3.org"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </a>
      ...
      <div className="h-[4000px] bg-blue-900 flex items-start justify-center pt-20">
        <button
      ...
      <Script id="lunacal-popup-init">
        {lunacalPopupInitScript}
      </Script>
    </main>
  );
}
