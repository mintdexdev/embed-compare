export const LUNACAL_LAZY_INLINE_EMBED_ID = "my-lunacal-inline-test-normal-event-type";

export const lunacalLazyInlineInitScript = `
...
Lunacal.ns["test-normal-event-type"]("inline", {
  elementOrSelector:"#${LUNACAL_LAZY_INLINE_EMBED_ID}",
  config: {"layout":""},
